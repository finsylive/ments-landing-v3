        ...
        <section id="terms" className="mb-16 p-6 bg-white rounded-xl border border-gray-200 shadow-sm scroll-mt-24">
          ...
          <div className="space-y-8">
            {[
              ...
              { title: "1.16 Governing Law & Dispute Resolution", content: "These Terms are governed by the laws of India. Any disputes shall first be attempted to be resolved through good-faith negotiation. If negotiation fails, disputes shall be subject to the exclusive jurisdiction of the courts in Mumbai, Maharashtra, India. You agree that dispute resolution will be conducted on an individual basis, not as a class action. Consumers in the EU/UK retain mandatory protections under local law." },
        ...
        <section id="privacy" className="mb-16 p-6 bg-white rounded-xl border border-gray-200 shadow-sm scroll-mt-24">
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <p className="text-gray-700 mt-2">Data Protection Officer<br />Ments<br />91springboard, Andheri East, Mumbai 400069, India</p>
            </div>
          </div>
        </section>

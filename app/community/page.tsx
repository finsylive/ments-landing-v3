...
export default function CommunityPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 relative overflow-hidden">
      ...
      <motion.div
        className="absolute top-20 left-20 text-4xl font-light text-gray-300 z-0"
        animate={{ rotate: 360 }}
      ...
      <motion.div
        className="absolute top-60 right-40 text-3xl font-light text-gray-300 z-0"
        animate={{ rotate: -360 }}
      ...
      <motion.div
        className="absolute bottom-40 left-60 text-5xl font-light text-gray-300 z-0"
        animate={{ rotate: 360 }}
      ...
      {/* More Floating Stars */}
      <motion.div
        className="absolute top-1/3 right-20 text-2xl font-light text-gray-300 z-0"
      ...
      <motion.div
        className="absolute bottom-20 right-40 text-3xl font-light text-gray-300 z-0"
